...
# To get started, put this script into a folder with the files (You'll have to create these yourself)
# and run makensis on it
...
#	file "logo.ico"
	...
	createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\Geac.exe" ""
#	createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\Geac.exe" "" "$INSTDIR\logo.ico"
